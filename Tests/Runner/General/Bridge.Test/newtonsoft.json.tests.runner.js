Bridge.assembly("Bridge.Test.Newtonsoft.Json.Tests", function ($asm, globals) {
    ...
    Bridge.define("Bridge.Test.Runtime.NewtonsoftJsonTestsRunner", {
        main: function Main () {
            ...
            QUnit.test("#106 - Test", Bridge.Test.Runtime.NewtonsoftJsonTestsRunner.Case106.Test);
    ...
    Bridge.define("Bridge.Test.Runtime.NewtonsoftJsonTestsRunner.Case106", {
        ...
        statics: {
            methods: {
                Test: function (assert) {
                    var $t;
                    var t = Bridge.Test.Runtime.TestFixture$1(Newtonsoft.Json.Tests.Issues.Case106).BeforeTest(false, assert, Bridge.Test.Runtime.NewtonsoftJsonTestsRunner.Case106, void 0, ($t = new Bridge.Test.Runtime.TestContext(), $t.Method = "Test()", $t.Line = "35", $t));
                    Newtonsoft.Json.Tests.Issues.Case106.Test();
                }
            }
        },
        fields: {
        ...
        statics: {
            methods: {
                TestExpectedType: function (assert) {
                    var $t;
                    var t = Bridge.Test.Runtime.TestFixture$1(Newtonsoft.Json.Tests.Issues.Case157).BeforeTest(false, assert, Bridge.Test.Runtime.NewtonsoftJsonTestsRunner.Case157, void 0, ($t = new Bridge.Test.Runtime.TestContext(), $t.Method = "TestExpectedType()", $t.Line = "21", $t));
